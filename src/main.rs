...
fn main() {
    ...
    let result = match cli.command {
        ...
        Command::DirectSync { url, rev, src, dst } =>
            sync::sync(Target::Direct(Parsed { name: None, dsc: None, mtd: None, url, rev, src, dst }), mode),
        Command::DirectCheck { url, rev, src, dst } =>
            check::check(Target::Direct(Parsed { name: None, dsc: None, mtd: None, url, rev, src, dst }), mode),
    };
